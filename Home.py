...
st.markdown("""
    <style>
        ...
        body {
            ...
            background-color: #DCD7C9; /* Light beige background */
        }
        .header {
            text-align: center;
            font-size: 2.5em;
            margin-top: 20px;
            color: #2C3639; /* Dark color for headers */
        }
        .subheader {
            text-align: center;
            font-size: 1.5em;
            color: #3F4E4F; /* Dark grey color for subheaders */
        }
        .login-container {
            max-width: 500px;
            margin: auto;
        ...
        .stButton > button {
            ...
            background-color: #A27B5C; /* Accent color for buttons */
            border-radius: 5px;
            transition: background-color 0.3s, transform 0.3s;
        }
        .stButton > button:hover {
            background-color: #8C6248; /* Darker accent color on hover */
